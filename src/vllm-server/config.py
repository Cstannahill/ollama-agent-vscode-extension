...
Manages model configurations and server settings for the vLLM integration
"""
...
class VLLMServerConfig(BaseSettings):
    """vLLM Server configuration settings"""
    ...
    # Model settings
    default_model: str = Field(default="microsoft/DialoGPT-medium", description="Default model to load")
